...
\input{illustration_hoeffding/illustration_hoeffding}

\section{The effect of scale (range) and normalisation of random variables in
Hoeffding's inequality}
\input{effect_scale/efect_scale}

\section{A Very Practical Question}
\input{very_practical/very_practical}

\section{Probability in Practice (``The Airline Question'')}
\input{probability_in_practice/probability_in_practice}

\section{Logistic Regression}
\input{logistic_regression/logistic_regression}
